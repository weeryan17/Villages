...
/**
 * This is the class for rotation a turret to a specified angle in radians. The angle will be calculated in the player finder.
 * TODO add tilt.
 * 
 * @author weeryan17
 *
...
public class Rotate {
	...
	/**
	 * This pans the armor stand to an angle.
	 * 
	 * @param player the player who owns the turret.
	 * @param turret the turret that is being rotated.
	 * @param angle the angle to rotate to.
	 */
	public void pantoAngle(String player, int turret, double angle){
		//angle is supposed to be in radians
		int x = this.instance.getTurretConfig(player).getInt("Turret." + turret + "." + "centerBlock" + ".x");
		int z = this.instance.getTurretConfig(player).getInt("Turret." + turret + "." + "centerBlcok" + ".z");
		String worldName = this.instance.getTurretConfig(player).getString("Turret " + turret + "." + "centerBlcok" + ".world");
		...
		ArmorStand stand1 = this.instance.getArmorStand(player, 1, turret);
		...
		ArmorStand stand2 = this.instance.getArmorStand(player, 2, turret);
		...
		ArmorStand stand3 = this.instance.getArmorStand(player, 3, turret);
		...
		ArmorStand stand4 = this.instance.getArmorStand(player, 4, turret);
		...
		ArmorStand stand5 = this.instance.getArmorStand(player, 5, turret);
		...
		ArmorStand stand6 = this.instance.getArmorStand(player, 6, turret);
		...
		ArmorStand stand7 = this.instance.getArmorStand(player, 7, turret);
		...
		ArmorStand stand8 = this.instance.getArmorStand(player, 8, turret);
		...
		ArmorStand stand9 = this.instance.getArmorStand(player, 9, turret);
